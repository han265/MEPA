...
class VARTrainer(object):
    def __init__(
        ...
        vae_local: VQVAE, var_wo_ddp: VAR, var: DDP, encoder: Optional[nn.Module],
        var_opt: AmpOptimizer, label_smooth: float, align_start: int, align_end: int,
    ):
    ...
    def train_step(
        ...
        raw_image_ = self.encoder.preprocess(inp_B3HW)
        ...
        with self.var_opt.amp_ctx:
            self.var_wo_ddp.forward
            logits_BLV, f_proj = self.var(label_B, x_BLCv_wo_first_l)

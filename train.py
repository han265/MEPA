...
from utils.load_encoder import load_encoders
...
def build_everything(args: arg_util.Args):
    ...
    encoder = load_encoders(args.enc_type, dist.get_device(), args.data_load_reso)
    ...
    trainer = VARTrainer(
        ...
        vae_local=vae_local, var_wo_ddp=var_wo_ddp, var=var, encoder=encoder, 
        var_opt=var_optim, label_smooth=args.ls, 
        align_start=args.align_start, align_end=args.align_end
    )
